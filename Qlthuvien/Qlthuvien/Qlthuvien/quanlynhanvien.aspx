<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="quanlynhanvien.aspx.cs" Inherits="Qlthuvien.quanlynhanvien" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Tendangnhap" DataSourceID="SqlDataSource2" OnRowDeleting="GridView1_RowDeleting1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
            <Columns>
                <asp:BoundField DataField="Tendangnhap" HeaderText="Tendangnhap" SortExpression="Tendangnhap" ReadOnly="True" />
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QLTHUVIENConnectionString %>" SelectCommand="SELECT * FROM [NHANVIEN]"></asp:SqlDataSource>
        <br />
    </div>
    </form>
</body>
