<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thongtinmuontra.aspx.cs" Inherits="Qlthuvien.thongtinmuontra" %>
...
<body>
    ...
    <p>
        ...
        <p>
            ...
            &nbsp;</p>
    <div>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Tendocgia" DataSourceID="SqlDataSource2">
            <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QLTHUVIENConnectionString3 %>" SelectCommand="SELECT * FROM [THONGTINMUONTRA]"></asp:SqlDataSource>
        </div>
    </div>
    </form>
</body>
